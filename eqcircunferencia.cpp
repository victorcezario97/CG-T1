...
void convertToCenter(int x, double y, int *newX, double *newY, int sizeX, int sizeY){

	*newX = x + sizeX/2;
	*newY = sizeY - (y+(sizeY/2));
}

void draw8Points(int x, double y, SDL_Renderer *renderer, int sizeX, int sizeY){
	double newY;
    int newX;
...
int main(int argc, char** argv)
{
    ...
    int sizeX = 2000, sizeY = 2000, r = 150, x = 0;
    double y;
    /*Time Mark Variables*/
    clock_t tStart, tEnd;
